...
class NuscDataset(BaseMapDataset):
    ...
    def __init__(self, data_root, aerial_data_root=None, **kwargs):
        ...
        if self.aerial_data_root is not None:
            assert os.path.exists(aerial_data_root), f'aerial_data_root {aerial_data_root} not exists'
    ...
    def get_sample(self, idx):
        ...
        input_dict = {
            ...
            'aerial_image_path': self.sample_token2aerial_fpath[sample['token']] if self.aerial_data_root is not None else None,
